...
def interpreter(fname):
    global light_list, sphere_list, cylinder_list, object_list, bgcolor
    light_list = []
    sphere_list = []
    cylinder_list = []
    object_list = []
    ...
    for line in lines:
        ...
        if words[0] == 'sphere':
            ...
            global surface
            #sphere_list.append(('sphere', x, y, z, radius, surface))
            ...
            #global cylinder_list
            #cylinder_list.append(('cylinder', radius, x, z, ymin, ymax, surface))
            global surface
...
def shade(ray, depth):
    ...
    if (hit is not None):
        ...
        if (s_refl_coef > 0):
            ...
            #refl_ray = Ray(refl_vec.array(), origin = [pos[0], pos[1], pos[2]])
...
def render_scene():
    ...
    for j in range(height):
        for i in range(width):
            ...
            set(i, j, color(pixel_color[0], pixel_color[1], pixel_color[2]))
