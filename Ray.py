...
class Ray:
    ...
    def getSphereHit(self, obj):
        ...
        if (b**2 - 4 * a * c < 0): #no intersection
            ...
            t_pos = (-1 * b + math.sqrt(b**2 - 4 * a * c))/(2 * a)
            t_neg = (-1 * b - math.sqrt(b**2 - 4 * a * c))/(2 * a)
    ...
    def getCylinderHit(self, obj):
        ...
        if (b**2 - 4 * a * c >= 0):
            ...
            if (t_pos > t_neg and t_neg > 0):
                ...
                t = t_pos
            #Check that the y-value at t is within cylinder bounds...
        ...
        if self.dy != 0:
            ...
            if math.sqrt((obj[2] - x) ** 2 + (obj[3] - z) ** 2) <= obj[1]: #if (x, z) is within circle
                t_min_end = t
            #YMAX endcap
